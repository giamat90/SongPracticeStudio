...
def import_yt(url: str, output_dir: str, stems_to_extract=None, on_progress=None) -> dict:
    """
    ...
    result = process(source_wav, output_dir, stems_to_extract=stems_to_extract, on_progress=remapped)
    result["title"] = title
    return result
